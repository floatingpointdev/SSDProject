Public Class CA_Entity
    Private _iID As Integer
    Private _sMemberID As String
    Private _dCAAmount As Double
    Private _dCAConsumable As Double
    ...
    Public Property dCAAmount() As Double
        Get
            Return _dCAAmount
        End Get
    ...
    Public Property dCAConsumable() As Double
        Get
            Return _dCAConsumable
        End Get
        Set(ByVal value As Double)
            _dCAConsumable = value
        End Set
    End Property
