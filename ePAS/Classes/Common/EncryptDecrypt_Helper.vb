...
Public Class EncryptDecrypt_Helper
    '=====================================TripleDES CBC Mode=============================================
    ...
    Public Function DiversifyKey(ByVal sKey As String, ByVal sInput As String) As String
        ...
        sKeyHex = oCommon.GetHexStrOfStr(sKey.PadRight(16, "0")) 'the key should be 16 bytes
        bKey = HexStringToBytes(sKeyHex)
        sInput = oCommon.GetHexStrOfStr(sInput.Substring(0, 8)) 'the input/message, should be in multiple of 8
